...
public class UtilisateurCRUDServiceTest {
	...
	public void testEnregistrerUser() {
		...
		UtilisateurCRUDService enregistrerUtilisateurService = (UtilisateurCRUDService) context.getBean("enregistrerUtilisateurService");
